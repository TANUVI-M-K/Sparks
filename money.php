...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/my1.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>View and Transact Money</strong> <img src="logos/my2.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
