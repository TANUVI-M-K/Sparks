...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="logos/m1.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>View and Transact Money</strong> <img src="logos/m2.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
 ...
 <div class="container">
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-outline-dark mb-3" name="submit" type="submit" id="myBtn" >Fill the Amount and Transfer Money</button>
            </div>
        </form>
    </div>    
